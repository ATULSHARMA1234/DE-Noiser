...
LEGACY_COLUMNS: list[tuple[str, str, Callable[[], Column], bool]] = [
    ...
    ("users", "external_id", lambda: Column("external_id", String(), nullable=True), True),
    ("users", "teams", lambda: Column("teams", JSON(), nullable=True), False),
    ...
    ("incidents", "severity", lambda: Column("severity", String(), nullable=True), False),
