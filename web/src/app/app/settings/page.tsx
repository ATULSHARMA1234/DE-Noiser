...
export default function SettingsPage() {
 ...
 <button
 onClick={handleSave}
 className={`font-bold rounded-lg px-5 py-2.5 text-xs flex items-center gap-2 transition-all cursor-pointer border-none ${saved ? 'bg-emerald-600 text-white' : 'bg-[var(--primary)] hover:bg-[var(--primary)] text-white'}`}
 >
 ...
 className="w-full h-1.5 bg-[var(--bg-track)] rounded-lg appearance-none cursor-pointer accent-[var(--primary)]" />
 ...
 <Bell size={16} className="text-[var(--primary)]" /> Alert Routing
 </h2>
 ...
 className="bg-[var(--primary)] hover:bg-[var(--primary)] text-white text-xs font-bold px-4 py-2 rounded-lg flex items-center gap-1.5 transition-colors cursor-pointer border-none">
 ...
 className="w-full bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)] text-xs rounded-lg px-3 py-2 outline-none focus:border-[var(--primary)]" />
 </div>
 <div>
 ...
 className="w-full bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)] text-xs rounded-lg px-3 py-2 outline-none appearance-none cursor-pointer focus:border-[var(--primary)]">
 ...
 className="w-full bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)] text-xs rounded-lg px-3 py-2 outline-none focus:border-[var(--primary)] font-mono" />
 </div>
 <div>
 ...
 className="bg-[var(--primary)] hover:bg-[var(--primary)] disabled:opacity-50 text-white text-xs font-bold px-4 py-2 rounded-lg flex items-center gap-2 transition-colors cursor-pointer border-none">
 ...
 className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-[var(--bg-surface-hover)] text-[var(--text-muted)] hover:text-[var(--primary)] transition-colors cursor-pointer border-none bg-transparent disabled:opacity-50">
