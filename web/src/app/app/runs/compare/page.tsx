...
function DriftIcon({ kind }: { kind: string }) {
 ...
 case 'volume_surge': return <TrendingUp size={14} className="text-[var(--primary)]" />;
...
function CompareView() {
 ...
 <RefreshCw size={24} className="animate-spin mb-4 text-[var(--primary)]" />
 ...
 <GitCompare size={20} className="text-[var(--primary)]" />
 Drift Analysis
 </h1>
 ...
 { label: 'Volume Surge', key: 'volume_surge', color: 'text-[var(--primary)]' },
 ...
 e.severity === 'MEDIUM' ? 'text-[var(--primary)]' : 'text-[var(--text-muted)]'
 }`}>
 {e.severity}
 </span>
 </td>
