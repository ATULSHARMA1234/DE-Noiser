...
export default function ServiceTopology() {
 ...
 <Network className="text-[var(--primary)]" size={24} /> Service Causal Topology
 </h1>
 ...
 className="bg-[var(--primary)] hover:bg-[var(--primary)] disabled:opacity-50 text-white font-bold rounded-lg px-4 py-2 text-xs flex items-center gap-1.5 transition-colors cursor-pointer border-none"
 >
 {loading ? (
 ...
 className="accent-[var(--primary)] w-24 h-1 bg-[var(--bg-track)] rounded-lg cursor-pointer"
 />
 <span className="text-xs font-mono font-bold text-[var(--primary)] w-8">{minConfidence.toFixed(2)}</span>
 </div>
 ...
 {nodes.length === 0 ? (
 <span className="text-[var(--text-muted)] italic font-normal">No services loaded</span>
 ) : (
 nodes.map(node => (
 ...
 <span className="text-[var(--text-muted)] border border-[var(--border)] px-1 rounded font-mono font-normal">Xms</span> Avg Delay Label
 </div>
 </div>
 </div>
 ...
 <div>
 <span className="text-[10px] font-bold tracking-widest text-[var(--primary)] bg-[var(--primary)] border border-[var(--primary)] px-2.5 py-1 rounded-sm uppercase">
 Causal Link Inspected
 </span>
 <h2 className="text-base font-bold text-[var(--text-primary)] mt-3 flex items-center gap-2">
 {selectedLink.source} <ArrowRight size={14} className="text-[var(--primary)]" /> {selectedLink.target}
 </h2>
 </div>
 </div>
 ...
 <p className="text-lg font-bold text-[var(--primary)] mt-1">{(selectedLink.confidence * 100).toFixed(0)}%</p>
 </div>
 <div className="bg-[var(--bg-input)] border border-[var(--border-subtle)] rounded-lg p-3 text-center">
 ...
 <div className="bg-[var(--primary)] border border-[var(--primary)] rounded-xl p-4 text-xs leading-relaxed text-[var(--text-secondary)]">
 <p className="text-[10px] font-bold text-[var(--primary)] uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
 <Zap size={10} className="text-[var(--primary)] animate-pulse" /> AI Causal Narration
 </p>
 {selectedLink.narrative}
 </div>
 )}
 ...
 <span className="text-[9px] font-bold text-[var(--primary)] font-mono bg-[var(--primary)] px-2 py-0.5 rounded-full border border-[var(--primary)] flex items-center gap-1 animate-pulse">
 ...
 <span className="text-xs font-bold text-[var(--primary)]">{(link.confidence * 100).toFixed(0)}%</span>
