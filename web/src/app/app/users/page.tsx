...
export default function UserDirectoryPage() {
 ...
 Only users with the <code className="text-[var(--primary)]">ADMIN</code> role can access the User Provisioning directory.
 </p>
 </div>
 );
 }
 ...
 <div>
 <div className="flex items-center gap-2 text-[var(--primary)] text-xs font-bold tracking-widest uppercase mb-1">
 <Sparkles size={12} />
 Platform Control
 </div>
 ...
 className="bg-[var(--primary)] hover:bg-[var(--primary)] text-white font-bold rounded-lg px-4 py-2 text-xs flex items-center gap-2 cursor-pointer transition-colors border-none"
 >
 ...
 u.role === 'ADMIN' ? 'from-[var(--primary)] to-[var(--primary)]' :
 ...
 {u.role === 'ADMIN' ? <ShieldCheck size={20} className="text-[var(--primary)]" /> :
 ...
 u.role === 'ADMIN' ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary)]' :
 ...
 <div className="absolute top-0 left-0 w-full h-[2px] from-transparent via-fuchsia-500 to-transparent"></div>
 ...
 className="w-full h-10 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl px-3.5 text-xs text-[var(--text-primary)] placeholder-[var(--text-dimmed)] outline-none focus:border-[var(--primary)] focus:bg-[var(--bg-surface-hover)]"
 />
 </div>
 ...
 className="w-full h-10 bg-[var(--bg-modal)] border border-[var(--border)] rounded-xl px-3 text-xs text-[var(--text-input)] outline-none focus:border-[var(--primary)]"
 >
 ...
 className="bg-[var(--primary)] hover:bg-[var(--primary)] disabled:opacity-50 text-white font-bold rounded-lg px-5 py-2 text-xs flex items-center gap-1.5 transition-colors cursor-pointer border-none"
 >
 {isSubmitting ? (
 <>
